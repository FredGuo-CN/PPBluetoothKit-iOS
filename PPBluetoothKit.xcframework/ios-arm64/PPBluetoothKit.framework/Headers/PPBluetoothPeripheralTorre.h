...
- (void)dataFindSurroundDevice:(void(^)(NSArray <PPTorreWifiDeviceModel *>*devices))handler;
...
- (void)dataConfigNetWork:(PPTorreConfigWifiModel *)model withHandler:(void(^)(PPWIFIConfigState state,  NSData *_Nullable errorCode))handler;
