...
typedef NS_ENUM(NSUInteger, BodyDetailUnitType) {
...
- (NSArray *)sortValuesFromDictionary:(NSDictionary *)dictionary andType:(BodyDetailUnitType)type;

- (NSArray *)fetchPPBodyParam_Weight_StandartArray;

- (NSArray *)fetchPPBodyParam_BodyFat_StandartArray;

- (NSArray *)fetchPPBodyParam_Water_StandartArray:(NSDictionary *)dic;

- (NSArray *)fetchPPBodyParam_Water_StandartArray;

- (NSArray *)fetchPPBodyParam_Mus_StandartArray:(NSDictionary *)dic;

- (NSArray *)fetchPPBodyParam_Mus_StandartArray;

- (NSArray *)fetchPPBodyParam_Bone_StandartArray:(NSDictionary *)dic;

- (NSArray *)fetchPPBodyParam_Bone_StandartArray;

- (NSArray *)fetchPPBodyParam_BMR_StandartArray;

- (NSArray *)fetchPPBodyParam_BMI_StandartArray8;
