...
+ (NSString *)deviceUnitByCBAdvDataManufacturerData:(NSData *)advData DeviceType:(PPDeviceType)type protocolType:(PPDeviceProtocolType)protocolType andDeivceName:(NSString *)deviceName;
